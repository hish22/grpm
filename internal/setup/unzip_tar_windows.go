...
func unzipTar(_ string, header *tar.Header, file io.Reader, _ int, _ bool) {
...
func tarReader(_ string, cfile io.Reader, location string, assetID int, _ bool) {
	...
	for {
		...
		unzipTar("", header, tarfile, assetID, false)
	}
}
